...
4. 选择 **ASP.NET Web Application**
   ...
   ![Create new ASP.NET project](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/new-asp-project.png)

5. 选择 **MVC**

   取消复选 "Host in the cloud" 本指南将使用一个本地示例。 ![Use MVC template](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/new-asp-project-template.png)
...
![Create new folder](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/new-folder.png)

将文件夹命名为 src。

![src folder](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/src-folder.png)

### 添加 TypeScript 代码

在 `src` 上右击并选择 **New Item**。 接着选择 **TypeScript File** 并将此文件命名为 `app.ts`。

![New item](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/new-item.png)
...
![Create tsconfig.json](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/new-tsconfig.png)
...
1. 在 **Solution Explorer** 中, 打开 **Views** \| **Home** \| `Index.cshtml`。
   ...
   ![Open Index.cshtml](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/open-index.png)
...
![Picture of running demo](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/running-demo.png)
...
![Demo paused on breakpoint](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/paused-demo.png)
...
2. 用 PackageInstaller 来安装 Angular 2， systemjs 和 Typings。
   ...
   ![Use PackageInstaller to install angular2](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/packageinstaller-angular2.png) ![Use PackageInstaller to install systemjs](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/packageinstaller-systemjs.png) ![Use PackageInstaller to install Typings](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/packageinstaller-typings.png)
...
3. 用 PackageInstaller 安装 es6-shim 的类型文件。
   ...
   ![Use PackageInstaller to install es6-shim typings](https://github.com/handycode/TypeScript/tree/24140e776561ba14d9dc45b487329a15d3967501/.gitbook/assets/packageinstaller-es6-shim.png)
